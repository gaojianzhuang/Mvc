...
namespace Microsoft.AspNet.Mvc.Rendering
{
    public static class DefaultDisplayTemplates
    {
        ...
        private static HtmlString BooleanTemplateCheckbox(bool value, IHtmlHelper htmlHelper)
        {
            ...
            return inputTag.ToHtmlString(TagRenderMode.SelfClosing);
        }
        ...
        private static HtmlString BooleanTemplateDropDownList(IHtmlHelper htmlHelper, bool? value)
        {
            ...
            var builder = new StringCollectionTextWriter();
            selectTag.ToHtmlString(TagRenderMode.StartTag).WriteTo(builder);
            ...
            selectTag.ToHtmlString(TagRenderMode.EndTag).WriteTo(builder);
        ...
        public static HtmlString CollectionTemplate(IHtmlHelper htmlHelper)
        {
            ...
            try
            {
                ...
                var result = new StringCollectionTextWriter();
            ...
            foreach (var propertyExplorer in modelExplorer.Properties)
            {
                ...
                if (!propertyMetadata.HideSurroundingHtml)
                {
                    ...
                    if (!string.IsNullOrEmpty(label))
                    {
                        ...
                        divTag.ToHtmlString(TagRenderMode.Normal).WriteTo(builder);
                        builder.WriteLine();
                    ...
                    divTag.ToHtmlString(TagRenderMode.StartTag).WriteTo(builder);
                }
                ...
                if (!propertyMetadata.HideSurroundingHtml)
                {
                    divTag.ToHtmlString(TagRenderMode.EndTag).WriteTo(builder);
                    builder.WriteLine();
                }
            }
        ...
        private static HtmlString HyperlinkTemplate(string uriString, string linkedText, IHtmlHelper htmlHelper)
        {
            ...
            return hyperlinkTag.ToHtmlString(TagRenderMode.Normal);
        }
    }
}
